...
void ResponseCurveComponent::timerCallback()
{
    ...
    if(parametersChenged.compareAndSetBool(false, true))
    {
...
void SimpleEQAudioProcessorEditor::resized()
{
    ...
    analyzerEnabledButton.setBounds(analyserEnabledArea);
    
    bounds.removeFromTop(5);
    
    float hRatio = 25.f / 100.f ; // JUCE_LIVE_CONSTANT(33) / 100.f;
    auto responceArea = bounds.removeFromTop(bounds.getHeight() * hRatio);
    
    responseCurveComponent.setBounds(responceArea);
